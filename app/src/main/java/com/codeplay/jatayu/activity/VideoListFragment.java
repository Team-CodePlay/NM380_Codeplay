...
import com.codeplay.jatayu.adapter.GeoVideoAdapter;
...
public class VideoListFragment extends Fragment {
	...
	private void refresh() {
		...
		videoAdapter.setOnUploadListener(video -> {
			...
			fileRef.putFile(FileProvider.getUriForFile(getContext(), "com.codeplay.jatayu.provider", new File(video.videoPath)))
